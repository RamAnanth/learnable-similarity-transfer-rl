...
class LunarLanderTransfer(gym.Env, EzPickle):
    metadata = {
    ...
    def __init__(self, density_ratio):
        ...
        self.density_ratio = density_ratio # Control density ratio
        self.reset()
    ...
    def reset(self):
        ...
        self.lander = self.world.CreateDynamicBody(
            ...
            fixtures = fixtureDef(
                ...
                density=5.0 * self.density_ratio,
                friction=0.1,
                categoryBits=0x0010,
